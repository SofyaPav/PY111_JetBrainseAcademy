...
def binary_search(
    ...
    middle_value = seq[middle_index]  # значения элемента с индексом middle_index
...
print(binary_search(37, [1,3,5,7,11,13,17,19,37,37,37,37, 37,37, 37,41,43,47,53,59], 0,20))
