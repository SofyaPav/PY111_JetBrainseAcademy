...
class PriorityQueue:
    ...
    def enqueue(self, elem: Any, priority: int = 0) -> None:
        ...
        """
        self.priority_queue[priority].append(elem)  # TODO реализовать метод enqueue
    ...
    def dequeue(self) -> Any:
        ...
        raise IndexError("Извлечение из пустой очереди не возможно")  # TODO реализовать метод dequeue
    ...
    def clear(self) -> None:
        """ Очистка очереди. """
        for queue in self.priority_queue.values():
            queue.clear()  # TODO реализовать метод clear
